                    ...
                    <div className="col">
                        <form>
                            <div className="page-three-card-right">
                                ...
                                <input type="email" className="form-control" id="email" placeholder="Enter name" name="email" style={{ background: "none", color: "white" }} />

                                <br /><label className="form-label">Email:</label>
                                <input type="email" className="form-control" id="email" placeholder="Enter email address" name="email" style={{ background: "none", color: "white" }} ></input>

                                <div className="mb-3 mt-3">
                                    <label >Project:</label>
                                    <textarea className="form-control" rows="5" id="comment" placeholder="Project" name="text" style={{ background: "none", color: "white" }} ></textarea>
